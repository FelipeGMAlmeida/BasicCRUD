...
# Remove certbot PPA — incompatível com Ubuntu 24.04 Noble
rm -f /etc/apt/sources.list.d/*certbot* 2>/dev/null || true
# Ignora erros de PPAs restantes para não abortar o script
